# Shlokph.github.io
.app-2rEoOp {
  background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.694) 33%, rgba(0, 0, 0, 0.598) 65%), url(https://wallpapercave.com/wp/wp3914161.jpg);
  background-size: cover;
  border: 1px;
}

.standardSidebarView-3F1I7i {
  background-image: url(https://wallpapercave.com/wp/wp3914161.jpg);
  background-size: cover;
}
